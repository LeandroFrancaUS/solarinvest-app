 ...
 * Priority:
 *   1. DATABASE_URL_ROLE_ADMIN  — explicit role-specific URL (preferred)
 *   2. ADMIN_DATABASE_URL       — alias accepted for convenience
 */
export function getRoleAdminConnectionString() {
  return sanitizeString(process.env.DATABASE_URL_ROLE_ADMIN || process.env.ADMIN_DATABASE_URL)
}
