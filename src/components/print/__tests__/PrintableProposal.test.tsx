...
describe('PrintableProposal (leasing)', () => {
  it('renderiza seções exclusivas de leasing com economia projetada', () => {
    ...
    expect(markup).toContain('Detalhamento técnico')
    expect(markup).toContain('Composição do sistema')
    expect(markup).toContain('Condições do contrato')
    expect(markup).toContain('Benefícios e retorno')
