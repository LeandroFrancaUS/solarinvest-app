        ...
        <div className="relative flex items-center">
          ...
          <input
            ...
            className={[
              ...
              'focus:outline-none focus:border-ds-primary focus:ring-1 focus:ring-[var(--input-focus-ring)]',
              'disabled:opacity-50 disabled:cursor-not-allowed',
              error ? 'border-ds-danger focus:border-ds-danger focus:ring-[var(--ds-danger-ring)]' : '',
              leftAddon ? 'pl-9' : '',
              rightAddon ? 'pr-9' : '',
              className,
            ]
