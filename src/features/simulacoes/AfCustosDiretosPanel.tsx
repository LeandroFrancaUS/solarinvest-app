...
export function AfCustosDiretosPanel({
  ...
  return (
    <div className="simulacoes-module-tile" style={{ marginBottom: '1rem' }}>
      ...
      <div className="af-custos-groups">

        {/* ── 1. Hardware ─────────────────────────────────────────── */}
        <div className="af-custos-group">
          <p className="af-custos-group-title">Hardware</p>
        ...
        {/* ── 2. Projeto e Licença ─────────────────────────────────── */}
        <div className="af-custos-group">
          <p className="af-custos-group-title">Projeto e Licença</p>
          <div className="grid g3">
        ...
        {/* ── 3. Deslocamento ──────────────────────────────────────── */}
        <div className="af-custos-group">
          <p className="af-custos-group-title">Deslocamento</p>
          <div className="grid g3">
        ...
        <div className="af-custos-group">
          <p className="af-custos-group-title">Parâmetros Financeiros</p>
          <div className="grid g3">
        ...
        {/* ── 5. Leasing (visible only in leasing mode) ───────────── */}
        {afModo === 'leasing' ? (
          <div className="af-custos-group">
            <p className="af-custos-group-title">Leasing</p>
            <div className="grid g3">
