...
export function closeProposalAndHydrateClientPortfolio(
  ...
  const resolvedUcBeneficiaria = clienteDados.ucBeneficiaria ?? normalizedBeneficiarias[0]
  const payload = mapProposalDataToPortfolioFields(snapshot, {
    ...clienteDados,
    ...(resolvedUcBeneficiaria !== undefined ? { ucBeneficiaria: resolvedUcBeneficiaria } : {}),
